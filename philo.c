...
/*   Updated: 2023/05/02 16:08:27 by yalee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	printf("philo ded: %i\nphilo num: %i\nstart time: %lld\neat time: 
		// %lld\nsleep time: %lld\ndie time: %lld\ntime must eat: %i\n",
		// table.philo_ded, table.philo_num, table.start_time, table.eat_time, 
		// table.sleep_time, table.die_time, table.time_must_eat);
// 	while(i < table.philo_num)
// 	{
// 		printf("philo name: %i\nis ded: %i\nisthinkin: %i\nis 
		// eatin: %i\nlast_eat: %lld\n", table.philo[i].name, 
		// table.philo[i].isded, table.philo[i].isthinking, 
		// table.philo[i].iseating, 
...
int	data_bad(t_table table)
{
	...
	if (table.die_time > 2147483647 || table.eat_time > 2147483647
